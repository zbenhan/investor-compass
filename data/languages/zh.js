...
const translations = {
    site: {
        title: "投知罗盘 - 投资风格测试、宏观经济指标分析、投资知识学习平台",
        brand: "投知罗盘",
        description: "投知罗盘是专业的投资研究辅助平台，提供投资风格测试、宏观经济指标分析、投资知识学习和调查报告工具。通过科学的测试方法帮助投资者了解自己的投资偏好，深入理解经济传导机制，提升投资决策水平。",
        keywords: "投资风格测试,投资门派,价值投资,技术分析,宏观投资,叙事投资,投资知识,宏观经济指标,利率,GDP,失业率,债券收益率,投资策略,股票分析,投资教育,投资方法论,A股投资,价值投资者,趋势投资,周期投资,投资罗盘"
    },
    language: {
        zh: "中文",
        en: "English",
    ...
    home: {
        ...
        featuresTitle: "网站功能",
        testDesc: "通过科学的测试题了解自己的投资风格和偏好，制定更合适的投资策略。",
        testButton: "开始测试",
        macroDesc: "探索利率、失业率、GDP等宏观经济指标之间的复杂联动关系，深入理解经济传导机制。",
        macroButton: "查看指标",
        articlesDesc: "学习专业的投资知识和理论，提升投资认知水平，掌握科学的投资方法论。",
        articlesButton: "学习知识",
        reportDesc: "辅助撰写、记录上市公司调查报告，系统化管理投资研究过程和调研成果。",
        reportButton: "开始撰写",
        aboutPara1: "投知罗盘是一个专业的投资研究辅助平台，致力于为投资者提供全方位的投资工具和知识支持。",
        aboutPara2: "通过风格测试帮助投资者了解自己的投资偏好，通过宏观指标分析深入理解经济运行规律，通过投资知识学习提升专业素养，通过调查报告工具系统化管理投资研究过程。",
        aboutPara3: "我们相信，科学的投资方法结合系统化的研究工具，能够帮助投资者在复杂的市场环境中做出更明智的决策。",
        schools: "投资门派",
