...
const translations = {
    site: {
        title: "性格罗盘 - 荣格性格测试 | 完整200题版本",
        brand: "性格罗盘",
        description: "性格罗盘提供基于荣格心理类型理论的200题专业性格测试，帮助你了解自己的性格类型(E/I, S/N, T/F, J/P)，揭示你的性格原型。",
        keywords: "性格测试,荣格性格测试,MBTI,性格类型,心理测试,人格测试,EI,SN,TF,JP,性格罗盘"
    },
    language: {
        zh: "中文",
        en: "English",
    ...
    home: {
        heroTitle: "性格罗盘",
        heroSubtitle: "200道专业题目，揭示你的性格原型。",
        startButton: "开始测试",
        styleTestButton: "性格测试",
        about: "关于我们",
        aboutContent: "性格罗盘是一个基于荣格心理类型理论的专业性格测试平台，通过200道科学设计的测试题帮助用户了解自己的性格类型和认知偏好。",
        featuresTitle: "网站功能",
        testDesc: "通过200道专业测试题了解自己的性格类型(E/I, S/N, T/F, J/P)，发现你的性格优势和特点。",
        testButton: "开始测试",
        macroDesc: "浏览性格心理学知识文章，深入了解不同性格类型的特点和心理学理论。",
        macroButton: "浏览文章",
        articlesDesc: "学习专业的性格心理学知识和理论，提升自我认知水平，了解不同性格类型的特征。",
        articlesButton: "学习知识",
        reportDesc: "了解性格类型对职业选择、人际关系和个人成长的影响，找到适合自己的发展方向。",
        reportButton: "了解更多",
        aboutPara1: "性格罗盘是一个专业的性格测试平台，致力于帮助用户深入了解自己的性格类型和认知偏好。",
        aboutPara2: "通过科学的荣格心理类型理论测试，帮助用户认识自己的性格特点，通过性格知识学习提升自我认知，通过文章阅读了解不同性格类型的特征。",
        aboutPara3: "我们相信，了解自己的性格类型能够帮助人们在职业发展、人际关系和个人成长中做出更适合自己的选择。",
        schools: "性格维度",
        schoolsValue: "外向(E) / 内向(I)",
        schoolsValueDesc: "关注你获取能量的方式：外向者从社交互动中获得能量，内向者从独处和内省中恢复精力。",
        schoolsTrend: "感觉(S) / 直觉(N)",
        schoolsTrendDesc: "关注你获取信息的方式：感觉型关注具体事实和细节，直觉型关注整体模式和未来可能性。",
        schoolsMacro: "思维(T) / 情感(F)",
        schoolsMacroDesc: "关注你做决策的方式：思维型依赖逻辑和客观原则，情感型考虑价值观和人际影响。",
        schoolsNarrative: "判断(J) / 知觉(P)",
        schoolsNarrativeDesc: "关注你对待生活的态度：判断型喜欢计划和组织，知觉型喜欢灵活和随性。",
        macroIndicators: "性格类型详解",
        macroIndicatorsDesc: "深入了解16种荣格性格类型的特点、优势和适合的发展方向，帮助你更好地认识自己和他人。",
        macroIndicatorsButton: "了解性格类型",
    },
    test: {
        title: "荣格性格测试",
        progress: "测试进度",
    ...
    terms: {
        title: "服务条款",
        intro: "欢迎使用性格罗盘（以下简称\"我们\"或\"网站\"）提供的服务。请仔细阅读以下服务条款，您的使用行为将被视为同意接受本条款的约束。",
        section1: "1. 服务内容",
        content1: "性格罗盘是一个性格测试平台，为用户提供荣格性格类型测试、性格知识文章阅读等服务。",
        section2: "2. 用户权利与义务",
        right1: "用户有权自由使用网站提供的测试服务和浏览性格知识文章。",
        right2: "用户应当遵守法律法规，不得利用网站进行任何违法活动。",
        right3: "用户应当尊重知识产权，不得复制、传播或修改网站上的内容。",
        right4: "用户应当保护自己的账号安全，如发现账号异常应及时联系我们。",
        right5: "用户同意接受网站展示的第三方广告和内容。",
        section3: "3. 网站权利与义务",
        ...
        section4: "4. 广告和第三方服务",
        adsIntro: "我们使用Google AdSense等第三方广告服务在我们的网站上展示广告。",
        ads1: "广告内容由第三方广告提供商提供，我们不对广告内容的准确性、合法性或适当性负责。",
        ads2: "用户点击广告后跳转到第三方网站，我们不对第三方网站的内容或服务负责。",
        ads3: "我们可能会与第三方服务提供商合作，以提供更好的用户体验和服务。",
        ads4: "第三方服务提供商可能有自己的隐私政策和使用条款，用户在使用第三方服务时应遵守相关规定。",
        section5: "5. Cookie使用",
        cookieIntro: "我们使用Cookie和类似技术来改善用户体验、分析网站流量和展示个性化广告。",
        cookie1: "继续使用我们的网站即表示您同意我们使用Cookie。",
        cookie2: "您可以通过浏览器设置管理或禁用Cookie，但这可能会影响网站的部分功能。",
        cookie3: "有关Cookie的详细信息，请参阅我们的隐私政策。",
        section6: "6. 知识产权保护",
        ip: "网站上的所有内容，包括但不限于文字、图片、音频、视频、图表、设计等，均受知识产权法的保护。未经授权，任何人不得复制、修改、传播或用于商业目的。",
        section7: "7. 免责声明",
        disclaimer: "网站提供的性格测试结果和知识文章仅供参考，不构成任何专业心理咨询或建议。用户应当自行判断和决策，网站不承担任何因使用网站内容而导致的损失。",
        section8: "8. 服务条款的变更",
        changes: "我们可能会不时更新本服务条款，更新后的条款将在网站上公布。用户应当定期查看服务条款的变更，继续使用网站服务将被视为接受变更后的条款。",
        section9: "9. 法律适用与争议解决",
    ...
    privacy: {
        title: "隐私政策",
        intro: "性格罗盘（以下简称\"我们\"）重视用户的隐私保护，我们将按照本隐私政策的规定收集、使用、保存和披露您的个人信息。",
        section1: "1. 我们收集的信息",
        ...
        protect3: "我们使用Cookie和类似技术来改善您的浏览体验、分析网站流量和展示个性化广告。",
        section4: "4. 信息共享",
        content4: "我们不会将您的个人信息出售、出租或与第三方共享，除非：",
        share1: "您明确同意",
        share2: "法律要求我们这样做",
        share3: "为了保护我们的权利、财产或安全",
        share4: "与可信的第三方服务提供商共享，以提供、维护和改进我们的服务",
        section5: "5. 广告服务",
        adsIntro: "我们使用Google AdSense等第三方广告服务在我们的网站上展示广告。",
        ads1: "这些广告服务可能会使用Cookie和类似技术来收集关于您访问我们网站的信息，以便向您展示可能感兴趣的广告。",
        ads2: "您可以通过浏览器设置管理或禁用Cookie，但这可能会影响网站的部分功能。",
        ads3: "第三方广告服务提供商（如Google）可能会根据您在我们网站和其他网站上的浏览行为来展示个性化广告。",
        ads4: "您可以通过访问Google的广告设置页面来管理个性化广告偏好：https://adssettings.google.com",
        section6: "6. Cookie政策",
        cookieIntro: "Cookie是存储在您设备上的小型文本文件，用于存储您的偏好设置和其他信息。",
        cookie1: "我们使用Cookie来记住您的语言偏好、登录状态和其他个性化设置。",
        cookie2: "我们还使用Cookie来分析网站流量和用户行为，以改进我们的服务。",
        cookie3: "第三方服务提供商（如Google Analytics和Google AdSense）也可能使用Cookie来收集数据。",
        cookie4: "您可以通过浏览器设置拒绝或删除Cookie，但请注意这可能会影响网站的功能。",
        cookieConsent: "Cookie 同意机制",
        cookieConsentIntro: "我们使用 Cookie 同意横幅来获得您的明确同意，特别是在欧盟/英国地区。当您首次访问我们的网站时，您会看到一个 Cookie 同意横幅，询问您是否接受 Cookie。",
        cookieConsentOptions: "您可以选择：",
        cookieConsentOption1: "接受所有 Cookie：允许所有类型的 Cookie，包括必要、分析和广告 Cookie。",
        cookieConsentOption2: "拒绝非必要 Cookie：只接受必要的 Cookie，拒绝分析和广告 Cookie。",
        cookieConsentDuration: "您的选择将被保存 365 天。您可以随时通过清除浏览器 Cookie 或重新访问网站来更改您的选择。",
        cookieManagement: "如何管理 Cookie",
        cookieManagementIntro: "您可以通过以下方式管理您的 Cookie 偏好：",
        cookieManagementStep1: "通过浏览器设置：大多数浏览器允许您查看和删除 Cookie。请访问您的浏览器设置页面，查找 Cookie 或隐私设置。",
        cookieManagementStep2: "通过 Google 广告设置：访问 https://adssettings.google.com 来管理您的个性化广告偏好。",
        cookieManagementStep3: "通过我们的 Cookie 同意横幅：您可以随时点击横幅上的\"设置\"按钮来更改您的 Cookie 偏好。",
        cookieManagementStep4: "清除所有 Cookie：如果您想重新开始，可以清除浏览器中的所有 Cookie，这将使 Cookie 同意横幅重新出现。",
        section7: "7. 隐私政策的变更",
    ...
    about: {
        title: "关于我们",
        intro: "性格罗盘是一个专业的性格测试和心理学知识分享平台，致力于帮助用户更好地了解自己的性格类型，提升自我认知水平。",
        mission: "我们的使命",
        missionContent: "我们的使命是通过科学的荣格心理类型理论测试和专业的心理学知识，帮助用户认识自己的性格偏好和特点，从而在职业发展、人际关系和个人成长中做出更适合自己的选择。",
        vision: "我们的愿景",
        visionContent: "成为最受用户信赖的性格测试和心理学教育平台，为用户提供个性化、专业化的性格分析指导，助力用户在生活和事业中发挥自己的性格优势。",
        team: "团队介绍",
        teamContent: "我们的团队由一群热爱心理学、具有丰富心理咨询和研究经验的专业人士组成，包括心理学研究者、心理咨询师、数据科学家和用户体验设计师。我们致力于将专业的心理学知识以通俗易懂的方式呈现给用户，帮助用户提升自我认知能力。",
        values: "核心价值观",
        value1: "专业性：我们坚持以科学的态度和方法为用户提供性格测试服务。",
        value2: "客观性：我们保持客观中立的立场，基于荣格理论提供测试结果。",
        value3: "实用性：我们注重内容的实用性，帮助用户将性格认知应用到实际生活中。",
    ...
    footer: {
        ...
        terms: "服务条款",
        about: "关于网站",
        copyright: "© 2025 性格罗盘 - A-share.com. 保留所有权利."
    },
    macro: {
    ...
    cookie: {
        title: "我们使用 Cookie",
        message: "我们使用 Cookie 和类似技术来改善您的浏览体验、分析网站流量和展示个性化广告。您可以随时在隐私政策中了解 Cookie 的使用情况。",
        accept: "接受所有",
        reject: "拒绝非必要",
        settings: "设置",
        necessary: "必要 Cookie",
        necessaryDesc: "这些 Cookie 是网站运行所必需的，无法禁用。",
        analytics: "分析 Cookie",
        analyticsDesc: "帮助我们了解用户如何使用网站，以便改进我们的服务。",
        advertising: "广告 Cookie",
        advertisingDesc: "用于展示与您相关的个性化广告。",
