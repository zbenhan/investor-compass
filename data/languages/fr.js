...
const translations = {
    ...
    report: {
        ...
        macroAnalysis: "Analyse d'investissement macro",
        narrativeAnalysis: "Analyse d'investissement narrative",
        ...
        importJSON: "Importer la sauvegarde",
        preview: "Aperçu",
        ...
        stockCode: "Code d'action",
        industry: "Industrie",
        reportDate: "Date du rapport",
        investmentGoal: "Objectif d'investissement",
        dimensionNotSelected: "Cette dimension n'est pas sélectionnée",
        selectDimensionFirst: "Veuillez d'abord sélectionner cette dimension dans l'étape 'Sélectionner les dimensions d'analyse'",
        goToDimensions: "Aller aux dimensions",
        selectOption: "Veuillez sélectionner",
        fillRequired: "Veuillez remplir tous les champs obligatoires",
        overwriteConfirm: "Le rapport existe déjà, voulez-vous l'écraser ?",
        investmentLogic: "Résumé de la logique d'investissement",
        riskAnalysis: "Analyse des risques",
        investmentAdvice: "Recommandations d'investissement",
